...
class StaticValues:
    ...
    methods = [
        ["Damerau-Levenshtein", {'orig': 0.55, 'sorted': 0.60, 'orig_onlylatin': 0.4, 'sorted_onlylatin': 0.6}],
        ["Jaro", {'orig': 0.75, 'sorted': 0.8, 'orig_onlylatin': 0.7, 'sorted_onlylatin': 0.6}],
        ["Jaro-Winkler", {'orig': 0.7, 'sorted': 0.85, 'orig_onlylatin': 0.7, 'sorted_onlylatin': 0.6}],
        ["Jaro-Winkler reversed", {'orig': 0.75, 'sorted': 0.75, 'orig_onlylatin': 0.7, 'sorted_onlylatin': 0.6}],
        ["Sorted Jaro-Winkler", {'orig': 0.7, 'sorted': 0.85, 'orig_onlylatin': 0.70, 'sorted_onlylatin': 0.6}],
        ["Permuted Jaro-Winkler", {'orig': 0.7, 'sorted': 0.7, 'orig_onlylatin': 0.60, 'sorted_onlylatin': 0.6}],
        ["Cosine N-grams", {'orig': 0.4, 'sorted': 0.7, 'orig_onlylatin': 0.35, 'sorted_onlylatin': 0.6}],
        ["Jaccard N-grams", {'orig': 0.25, 'sorted': 0.35, 'orig_onlylatin': 0.30, 'sorted_onlylatin': 0.6}],
        ["Dice bigrams", {'orig': 0.5, 'sorted': 0.55, 'orig_onlylatin': 0.4, 'sorted_onlylatin': 0.6}],
        ["Jaccard skipgrams", {'orig': 0.45, 'sorted': 0.55, 'orig_onlylatin': 0.4, 'sorted_onlylatin': 0.6}],
        ["Monge-Elkan", {'orig': 0.7, 'sorted': 0.85, 'orig_onlylatin': 0.7, 'sorted_onlylatin': 0.6}],
        ["Soft-Jaccard", {'orig': 0.6, 'sorted': 0.7, 'orig_onlylatin': 0.55, 'sorted_onlylatin': 0.6}],
        ["Davis and De Salles", {'orig': 0.65, 'sorted': 0.7, 'orig_onlylatin': 0.6, 'sorted_onlylatin': 0.6}],
        ["LinkGeoML Jaro-Winkler", {'orig': 0.7, 'sorted': 0.85, 'orig_onlylatin': 0.70, 'sorted_onlylatin': 0.6}],
        ["LinkGeoML Jaro-Winkler reversed", {'orig': 0.75, 'sorted': 0.75, 'orig_onlylatin': 0.75, 'sorted_onlylatin': 0.6}],
