...
class StaticValues:
    ...
    MetricOptimalValues = {
        'latin': {
            ...
            'damerau_levenshtein': {'simple': [0.4, [0.34, 0.3, 0.3]], 'avg': [0.8, [0.5, 0.1, 0.4]]},
            'jaro': {'simple': [0.7, [0.34, 0.3, 0.3]], 'avg': [0.8, [0.7, 0.1, 0.2]]},
            'jaro_winkler': {'simple': [0.7, [0.34, 0.3, 0.3]], 'avg': [0.8, [0.6, 0.1, 0.3]]},
            'jaro_winkler_r': {'simple': [0.7, [0.34, 0.3, 0.3]], 'avg': [0.8, [0.7, 0.1, 0.2]]},
            'permuted_winkler': [],
            'sorted_winkler': [],
            'cosine': {'simple': [0.35, [0.34, 0.3, 0.3]], 'avg': [0.8, [0.4, 0.2, 0.4]]},
            'jaccard': {'simple': [0.35, [0.34, 0.3, 0.3]], 'avg': [0.8, [0.334, 0.333, 0.333]]},
            'strike_a_match': {'simple': [0.4, [0.34, 0.3, 0.3]], 'avg': [0.8, [0.4, 0.2, 0.4]]},
            'skipgram': {'simple': [0.45, [0.34, 0.3, 0.3]], 'avg': [0.8, [0.334, 0.333, 0.333]]},
            'monge_elkan': {'simple': [0.75, [0.34, 0.3, 0.3]], 'avg': [0.8, [0.6, 0.1, 0.3]]},
            ...
            'l_jaro_winkler_r': {'simple': [0.7, [0.34, 0.3, 0.3]], 'avg': [0.8, [0.7, 0.1, 0.2]]},
        },
        'global': {
