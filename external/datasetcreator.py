...
class LSimilarityVars:
    ...
    per_metric_optimal_values = {
        ...
        'damerau_levenshtein': {'simple': [0.6, [0.4, 0.5, 0.1]], 'avg': [0.8, [0.5, 0.1, 0.4]]},
        'jaro': {'simple': [0.6, [0.4, 0.5, 0.1]], 'avg': [0.8, [0.7, 0.1, 0.2]]},
        'jaro_winkler': {'simple': [0.6, [0.4, 0.5, 0.1]], 'avg': [0.8, [0.6, 0.1, 0.3]]},
        'jaro_winkler_r': {'simple': [0.6, [0.4, 0.5, 0.1]], 'avg': [0.8, [0.7, 0.1, 0.2]]},
        'permuted_winkler': [],
        'sorted_winkler': [],
        'cosine': {'simple': [0.6, [0.4, 0.5, 0.1]], 'avg': [0.8, [0.4, 0.2, 0.4]]},
        'jaccard': {'simple': [0.6, [0.4, 0.5, 0.1]], 'avg': [0.8, [0.334, 0.333, 0.333]]},
        'strike_a_match': {'simple': [0.6, [0.4, 0.5, 0.1]], 'avg': [0.8, [0.4, 0.2, 0.4]]},
        'skipgram': {'simple': [0.6, [0.4, 0.5, 0.1]], 'avg': [0.8, [0.334, 0.333, 0.333]]},
        'monge_elkan': {'simple': [0.6, [0.4, 0.5, 0.1]], 'avg': [0.8, [0.6, 0.1, 0.3]]},
        'soft_jaccard': {'simple': [0.6, [0.4, 0.5, 0.1]], 'avg': [0.8, [0.5, 0.1, 0.4]]},
        'davies': {'simple': [0.6, [0.4, 0.5, 0.1]], 'avg': [0.8, [0.6, 0.1, 0.3]]},
        'l_jaro_winkler': {'simple': [0.6, [0.4, 0.5, 0.1]], 'avg': [0.8, [0.6, 0.1, 0.3]]},
        'l_jaro_winkler_r': {'simple': [0.6, [0.4, 0.5, 0.1]], 'avg': [0.8, [0.7, 0.1, 0.2]]},
    }
