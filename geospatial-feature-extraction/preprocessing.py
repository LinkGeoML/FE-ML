...
def get_train_test_sets(conn, args, poi_ids_train, poi_ids_test):
	...
	poi_id_to_word_features = get_features_top_k(conn, args)
	poi_id_to_word_features_ngrams = get_features_top_k_ngrams(conn, args)
	closest_pois_boolean_and_counts_per_label = get_closest_pois_boolean_and_counts_per_label(conn, args, float(args["threshold"]))
	closest_pois_boolean_and_counts_per_label_streets = get_closest_pois_boolean_and_counts_per_label_streets(conn, args, float(args["threshold"]))
